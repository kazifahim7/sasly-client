                    ...
                    <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                        <div>
                            ...
                            <div className="mt-10 sm:flex sm:items-center sm:space-x-8 items-center ">
                                <Link href="/product" className="inline-flex items-center rounded-3xl justify-center px-10 py-4 text-base font-semibold text-black transition-all duration-200 bg-orange-400 hover:bg-orange-600" role="button">Start exploring</Link>
                                <Link href="/product" className="inline-flex items-center   mt-8 text-base font-semibold transition-all duration-200 sm:mt-0 hover:opacity-80">
